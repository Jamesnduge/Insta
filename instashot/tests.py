...
class ImageTestClass(TestCase):
    ...
    def setUp(self):
        self.new_user = User(username = "jim", email = "jim@uu.com",password = "password")
        self.new_user.save()
        self.new_image = Image(Image_name = 'jim', poster = self.new_user)
        self.new_image.save()
    ...
    def test_init(self):
        self.assertTrue(self.new_image.name =='jim')
...
class CommentTestCases(TestCase):
    ...
    def setUp(self):
        ...
        self.new_user = User(username = "jim", email = "jim@uu.com",password = "password")
        self.new_user.save()
        self.new_image = Image(name = 'jim', poster = self.new_user)
        self.new_image.save_image()
...
class ProfileTestClas(TestCase):
    ...
    def setUp(self):
        user = User(username='thymashite')
        self.profile = Profile(prof_pic='jim', bio='very awesome', user=user)
    ...
    def test_search_users(self):
        ...
        """
        users = Profile.search_profile("James")
